<%@page import="groovy.ui.SystemOutputInterceptor"%>
...
<body>
<%List<Student> can=(List<Student>)pageContext.getAttribute("tobereported", PageContext.APPLICATION_SCOPE); 
out.println(can);
File fgen=null;
String hai="";
try
{
	...
	InputStream resourceStream = session.getServletContext().getResourceAsStream("resources/mite.jrxml");
